 ...
 *
 * @returns {DprApplication} A random DPR application object.
 */
  ...
  return {
    application: {
      ...
      documents: [
        ...
        ...generateNResults(10, generateDocument),
      ],
    },
    property: {
      address: {
 ...
 */
export const generateBoundaryGeoJson =
  (): DprApplication["property"]["boundary"]["site"] => {
    const options: DprApplication["property"]["boundary"]["site"][] = [
      {
        type: "Feature",
        geometry: {
          type: "MultiPolygon",
