...
export const documentation: Documentation = {
  url: `/admin/json?handler=ApiV1&method=postComment`,
  ...
  examples: [
    {
      url: `/admin/json?handler=ApiV1&method=postComment&applicationId=1&source=bops&council=camden&apiData=1`,
      description: "BOPS Submitting a comment to BOPS",
    },
    {
      url: `/admin/json?handler=ApiV1&method=postComment&applicationId=1&source=local&council=camden&apiData=1`,
