...
export const documentation: Documentation = {
  url: `/admin/json?handler=BopsV2&method=show`,
  ...
  examples: [
    {
      url: `/admin/json?handler=BopsV2&method=show&council=camden&reference=24-00136-HAPP`,
    ...
    {
      url: `/admin/json?handler=BopsV2&method=show&council=camden&reference=doesnotexist`,
