...
export const documentation: Documentation = {
  url: `/admin/json?handler=BopsV2&method=search`,
  ...
  examples: [
    {
      url: `/admin/json?handler=BopsV2&method=search&page=1&resultsPerPage=10&council=camden`,
      description: "search page 1",
    },
    {
      url: `/admin/json?handler=BopsV2&method=search&page=3&resultsPerPage=10&council=camden`,
      description: "search page 3",
    },
    {
      url: `/admin/json?handler=BopsV2&method=search&page=1&resultsPerPage=10&council=camden&searchQuery=HAPP`,
      description: "search search w results",
    },
    {
      url: `/admin/json?handler=BopsV2&method=search&page=1&resultsPerPage=10&council=camden&searchQuery=noresultsplease`,
