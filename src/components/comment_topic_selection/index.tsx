                  ...
                  <details className="govuk-details">
                    ...
                    <div className="govuk-details__text">
                      <p className="govuk-body">
                        As part of the negotiation, the case officer can take
                        into consideration all comments which are 'material
                      ...
                      <p className="govuk-body">
                        Issues such as loss of private view or negative impact
                        on property values, or civil matters like 'right to
