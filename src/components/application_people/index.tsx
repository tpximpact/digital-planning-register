...
const ApplicationPeople = ({applicant_first_name, applicant_last_name, agent_first_name, agent_last_name}: Data) => {
    return(
        <>
            <h2 className="govuk-heading-l">People</h2> 
                ...
                <div className="govuk-grid-column-one-third-from-desktop grid-row-extra-bottom-margin">
                    ...
                    <div className="govuk-grid-column-full">
                        ...
                        <p className="govuk-body" role="applicant-name">{applicant_first_name} {applicant_last_name}</p>
                    </div>
                    </div>
                    <div className="govuk-grid-row">
                    <div className="govuk-grid-column-full">
                ...
                <div className="govuk-grid-column-one-third-from-desktop grid-row-extra-bottom-margin">
                    ...
                    <div className="govuk-grid-column-full">
                        <h4 className="govuk-heading-s">Name</h4>
                        <p className="govuk-body" role="agent-name">{agent_first_name} {agent_last_name}</p>
                    </div>
                    </div>
