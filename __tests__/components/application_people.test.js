...
describe('Render ApplicationPeople', () => {
    ...
    it('should render correct', async() => {
        ...
        expect(screen.getByRole("agent-name", {Name:`${mockData.agent_first_name} ${mockData.agent_first_name}`}));
        expect(screen.getByRole("applicant-name", {Name:`${mockData.applicant_first_name} ${mockData.applicant_first_name}`}));
    })
})