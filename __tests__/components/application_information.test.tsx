...
import { DprApiShowResponse } from "@/types";
...
describe("Render ApplicationInformation", () => {
  const mockData: DprApiShowResponse = {
    application: {
...
describe("Render ApplicationInformation", () => {
  ...
  it("should render correctly with MultiPolygon geometry", () => {
    const mockDataWithMultiPolygon: DprApiShowResponse = {
      ...mockData,
      property: {
        ...mockData.property,
        boundary: {
  ...
  it("should render correctly with FeatureCollection", () => {
    const mockDataWithFeatureCollection: DprApiShowResponse = {
      ...mockData,
      property: {
        ...mockData.property,
        boundary: {
